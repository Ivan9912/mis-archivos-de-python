...
plt.show()
print ("Llenar el album costará... %2.f pesos. Y qué hago con las %d repetidas?!", "%(sobres_promedio * 20, sobres_promedio * FIGURITAS_POR_PAQUETE - FIGURITAS_ POR_ALBUM)")
